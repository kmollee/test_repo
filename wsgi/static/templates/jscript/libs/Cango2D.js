/*==========================================================================
  ...
  Rev: 1
  By: A.R.Collins
  Description: A 2D grpahics library for the canvas element designed for
...
// step 1 將程式庫放到 libs 目錄中)

// step 2 寫成 $module 格式
$module = {
	__getattr__ : function(attr){return this[attr]},
    // 並不確定是否應該使用 setattr
    __setattr__ : function(attr,value){return this[attr]=value},
	cango : function(canvasId){return new Cango2D(canvasId)},
    tweener : function(values, delayTime, dur, loopStr){return new Tweener(values, delayTime, dur, loopStr)},
    svgtocgo2d : function(svgPath, xRef, yRef){return new svgToCgo2D(svgPath, xRef, yRef)},
    ...
    shapes2d : { __getattr__ : function(attr){return this[attr]},
...
$module.__str__ = function(){return "<module 'Cango2D-1v00'>"}

// 以下為原有的 anonymous 函式定義並且執行, 在 Cango2D 中必須加入 step 3 的 __getattr__  function
// 否則無法使用 cango 的屬性與成員方法
(function()
{
  /*-----------------------------------------------------------------------------------------
...
(function()
{
  ...
  function Group2D()
  {
    ...
    // Step 4: Yen 為了要讓 Group2D 物件可以透過 Brython 取得屬性與方法
  ...
  function Obj2D(cgo, commands, objtype, fillColor, strokeColor)
  {
    ...
    // Step 4: Yen 為了要讓 Obj2D 物件可以透過 Brython 取得屬性與方法
    this.__getattr__ = function(attr){return $getattr(this,attr)};
    this.__setattr__ = function(attr,value){return this[attr]=value};
